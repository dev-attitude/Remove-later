...
export const ASSIGNMENT_WRITING_PACKAGES: BusinessPackage[] = [
  {
    ...
    name: "Undergraduate Assignment",
    price: 200,
    priceLabel: "",
    currency: "NAD",
    description: "Undergraduate essays, case studies, reports, and module deliverables.",
    popular: true,
    includes: [
      "Structured to your rubric and faculty guidelines",
      "Academic tone & argument structure",
      "APA / Harvard formatting",
      "Editing, proofreading & one revision round",
    ],
  },
  {
    ...
    priceLabel: "",
    currency: "NAD",
    description: "Honours, masters, and postgraduate-level assignments with deeper analysis.",
    includes: [
      "Advanced academic writing",
      "Critical analysis & literature integration",
      "Institutional formatting",
      "Editing, proofreading & revision support",
    ],
  },
];
...
export const RESEARCH_WRITING_PACKAGES: BusinessPackage[] = [
  {
    id: "research-proposal-undergrad",
    name: "Research Proposal — Undergraduate",
    price: 1500,
    priceLabel: "",
    currency: "NAD",
    description: "Full undergraduate research proposal for ethics submission and supervisor approval.",
    popular: true,
    includes: [
  ...
  {
    id: "research-proposal-postgrad",
    name: "Research Proposal — Postgraduate",
    price: 2000,
    priceLabel: "",
    currency: "NAD",
    description: "Postgraduate research proposal with deeper theoretical and methodological framing.",
    includes: [
      "Honours / masters-level proposal structure",
      "Literature review & research gap",
      "Detailed methodology",
      "Ethics-ready formatting",
    ],
  },
  {
    id: "research-phd-monthly",
    name: "PhD Research Assistance",
    price: 800,
    priceLabel: "Per month",
    currency: "NAD",
    description:
      "Ongoing PhD research support from the beginning to the end of your programme — milestones agreed with your supervisor.",
    includes: [
      "Monthly guidance & chapter support",
      "Proposal through to final submission",
      "Supervisor feedback revisions",
      "Consistent academic writing support",
    ],
  },
  {
    id: "research-thesis-undergrad",
    name: "Thesis — Undergraduate",
    price: 2000,
    priceLabel: "",
    currency: "NAD",
    description: "Undergraduate thesis or dissertation project support.",
    includes: [
      "Full thesis structure & drafting",
  ...
  {
    id: "research-thesis-postgrad",
    name: "Thesis — Postgraduate",
    price: 2800,
    priceLabel: "",
    currency: "NAD",
    description: "Postgraduate thesis or dissertation support (honours / advanced diploma level).",
    includes: [
      "All core chapters scoped to your institution",
      "Literature & methodology integration",
      "Results and discussion support",
      "Supervisor revision rounds",
    ],
  },
  {
    id: "research-thesis-masters",
    name: "Thesis — Masters Level",
    price: 3500,
    priceLabel: "",
    currency: "NAD",
    description: "Masters-level dissertation or thesis — full project support.",
    includes: [
      "Masters-standard academic writing",
      "Full chapter development",
      "Data integration where applicable",
      "Submission-ready formatting",
    ],
  },
  {
    id: "data-collection-qualitative",
    name: "Data Collection — Qualitative",
    price: 1500,
    priceLabel: "",
    currency: "NAD",
    description: "Qualitative data collection support — interviews, focus groups, and field instruments.",
    includes: [
      "Interview / focus group guides",
      "Recruitment & scheduling support",
      "Fieldwork planning",
      "Organised qualitative dataset handover",
    ],
  },
  {
    id: "data-collection-quantitative",
    name: "Data Collection — Quantitative",
    price: 2800,
    priceLabel: "",
    currency: "NAD",
    description: "Quantitative data collection including survey deployment and transcript preparation.",
    includes: [
      "Survey / questionnaire design",
      "Data collection & entry support",
      "Transcript included",
