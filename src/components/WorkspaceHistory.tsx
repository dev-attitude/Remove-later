...
export function WorkspaceHistory({
  ...
  if (items.length === 0) {
    return (
      <div className="mb-6 rounded-lg border border-dashed border-line bg-cream-50/80 px-4 py-3 text-sm text-muted">
        <History className="mb-1 inline h-4 w-4 text-muted" /> {label} — saved
  ...
  return (
    <div className="mb-6 rounded-lg border border-line bg-offwhite p-4">
