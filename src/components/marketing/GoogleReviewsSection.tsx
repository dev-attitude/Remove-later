...
export async function GoogleReviewsSection() {
  ...
  return (
    <section id="reviews" className="border-t border-line bg-cream py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
            {data.rating != null && data.totalReviews > 0 && (
              <div className="rounded-xl border border-line bg-cream-50 px-5 py-3">
                <div className="flex items-center gap-3">
                  <StarRating rating={data.rating} size="lg" />
                  <div>
                    <p className="text-2xl font-semibold text-charcoal">{data.rating.toFixed(1)}</p>
            ...
            >
              <Star className="h-4 w-4 fill-offwhite/90" />
              Leave a review
            </a>
          </div>
        </div>
        ...
        {hasReviews ? (
          ...
          <div className="mt-10 rounded-2xl border border-line bg-cream-50 p-10 text-center">
            <StarRating rating={data.rating ?? 5} size="lg" className="justify-center" />
            <p className="mt-4 text-lg font-normal text-charcoal">
          ...
          <div className="mt-10 rounded-2xl border border-dashed border-charcoal/25 bg-cream-50 p-10 text-center">
        ...
        <p className="mt-8 text-center text-xs text-muted">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="font-normal text-charcoal underline underline-offset-2 hover:opacity-70"
          >
            Google
          </a>
