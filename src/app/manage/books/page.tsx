    ...
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.4fr]">
          ...
          <form onSubmit={handleUpload} className="mt-4 space-y-4">
            <div>
              ...
              <input
                ...
                type="file"
                accept=".pdf,.docx,.txt"
                className="mt-1 block w-full text-sm text-slate-600 file:mr-3 file:rounded-lg file:border-0 file:bg-brand-50 file:px-3 file:py-2 file:text-sm file:font-semibold file:text-brand-700 hover:file:bg-brand-100"
              />
            </div>
            <div>
              <label className="text-xs font-medium text-slate-600">
        ...
        <Card className="!p-0 overflow-hidden">
          ...
          {!books ? (
            <p className="p-5 text-sm text-slate-500">Loading textbooks…</p>
          ) : books.length === 0 ? (
