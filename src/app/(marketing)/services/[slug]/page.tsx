  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 md:px-8 md:py-24">
      ...
      <div className="mt-8 flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-600/25 text-brand-300">
        ...
        <div>
          ...
          <p className="mt-1 text-slate-400">{service.short}</p>
        </div>
      </div>

      <p className="mt-8 text-lg leading-relaxed text-slate-300">{service.description}</p>
