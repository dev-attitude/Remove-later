...
export default function CampusLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-charcoal via-charcoal to-blue-900 p-6">
      <Card className="w-full max-w-md border-0 shadow-2xl">
        ...
        <div className="mt-4 space-y-2 rounded-lg bg-cream-50 p-3 text-xs text-charcoal">
          ...
          {[
            ...
            <p key={mail}>
              ...
              <code className="rounded bg-offwhite px-1">{mail}</code> /{" "}
              <code className="rounded bg-offwhite px-1">{pass}</code>
            </p>
          ))}
        </div>
